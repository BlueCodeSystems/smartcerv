...
public class VisitEntityMock extends SynchronizableEntity {
    ...
    @Ignore
    public VisitEntityMock(long visitId, long visitTypeId, long patientId, Long locationId, Long creator, LocalDateTime dateStarted){
    ...
    @Ignore
    public VisitEntityMock(long visitId, long visitTypeId, long patientId, Long locationId, Long creator, LocalDateTime dateStarted, LocalDateTime dateStopped){
