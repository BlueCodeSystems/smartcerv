...
public interface EntityMetadataDao {
    ...
    @Query("SELECT DISTINCT entity_id FROM entity_metadata WHERE entity_type_id = :entityTypeId AND remote_status_code != :remoteStatus ORDER BY last_modified DESC LIMIT 10")
