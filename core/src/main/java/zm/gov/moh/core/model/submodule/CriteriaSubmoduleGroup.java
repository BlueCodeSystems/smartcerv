...
public class CriteriaSubmoduleGroup extends AbstractSubmoduleGroup {

    CriteriaSubmoduleGroup(String string, Class classInstance,Criteria criteria, List<Submodule> submodule){
        super(string,classInstance,criteria,submodule);
