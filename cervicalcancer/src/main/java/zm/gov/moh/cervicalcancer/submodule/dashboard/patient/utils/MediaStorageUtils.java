...
import zm.gov.moh.cervicalcancer.submodule.dashboard.patient.view.AppConstantFragment;
...
public class MediaStorageUtils {
    ...
    // constructor
    public MediaStorageUtils(Context context) {
    ...
    public ArrayList<String> getFilePaths() {
        ...
        File directory = new File(
                android.os.Environment.getExternalStorageDirectory()
                        + File.separator + AppConstantFragment.PHOTO_ALBUM);
    ...
    private boolean IsSupportedFile(String filePath) {
        ...
        if (AppConstantFragment.FILE_EXTN
