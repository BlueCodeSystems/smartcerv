...
public class DRTBAdministrationOfDrugsTableWidget extends BaseWidget {
    ...
    public DRTBAdministrationOfDrugsTableWidget(Context context) {
        super(context);
    }
    ...
    public void onCreateView() {
        ...
        this.addView(inflater.inflate(R.layout.dr_tb_administraton_of_drugs, null));
   ...
   /* public void setValue(Object value) {
    ...
    public static class Builder extends BaseWidget.Builder{
        ...
        public int getRowSize() {
         ...
         public DRTBAdministrationOfDrugsTableWidget.Builder setBundle(Bundle bundle) {
             mBundle = bundle;
             return this;
         }
        ...
        public BaseWidget build() {
            ...
            DRTBAdministrationOfDrugsTableWidget widget = new DRTBAdministrationOfDrugsTableWidget(mContext);
