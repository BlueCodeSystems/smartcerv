...
public class DRTBDrugCessationOfDrugsTableWidget extends BaseWidget {
    ...
    public DRTBDrugCessationOfDrugsTableWidget(Context context) {
        super(context);
    }
    ...
    public void onCreateView() {
        ...
        this.addView(inflater.inflate(R.layout.dr_tb_drug_date_started_and_dosage_cessation_of_drugs, null));
   ...
   /* public void setValue(Object value) {
    ...
    public static class Builder extends BaseWidget.Builder{
        ...
        public int getRowSize() {
         ...
         public DRTBDrugCessationOfDrugsTableWidget.Builder setBundle(Bundle bundle) {
             mBundle = bundle;
             return this;
         }
        ...
        public BaseWidget build() {
            ...
            DRTBDrugCessationOfDrugsTableWidget widget = new DRTBDrugCessationOfDrugsTableWidget(mContext);
