...
public class CameraConnectButtonWidget extends ConceptWidget<ObsValue<String>> implements View.OnClickListener, Retainable  {
    ...
    public CameraConnectButtonWidget(Context context) {
        super(context);
    }
    ...
    public static class Builder extends ConceptWidget.Builder{
        ...
        public CameraConnectButtonWidget.Builder setLabel(String label){
            mLabel = label;
            return this;
        }
        public CameraConnectButtonWidget.Builder setBundle(Bundle bundle){
            mBundle = bundle;
            return this;
        }
        @Override
        public BaseWidget build() {
            CameraConnectButtonWidget widget = new CameraConnectButtonWidget(mContext);
            if(mLabel != null)
