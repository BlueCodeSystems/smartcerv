...
public class DRTBSputumSmearMicroscopyTableWidget extends BaseWidget {
    ...
    public DRTBSputumSmearMicroscopyTableWidget(Context context) {
        super(context);
    }
    ...
    public void onCreateView() {
        ...
        this.addView(inflater.inflate(R.layout.dr_tb_sputum_smear_microscopy, null));
   ...
   /* public void setValue(Object value) {
    ...
    public static class Builder extends BaseWidget.Builder{
        ...
        public int getRowSize() {
         ...
         public DRTBSputumSmearMicroscopyTableWidget.Builder setBundle(Bundle bundle) {
             mBundle = bundle;
             return this;
         }
        ...
        public BaseWidget build() {
            ...
            DRTBSputumSmearMicroscopyTableWidget widget = new DRTBSputumSmearMicroscopyTableWidget(mContext);
