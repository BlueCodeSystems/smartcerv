...
public class DRPreviousTBTreatmentTableWidget extends BaseWidget {
    ...
    public DRPreviousTBTreatmentTableWidget(Context context) {
        super(context);
    }
    ...
    public void onCreateView() {
        ...
        this.addView(inflater.inflate(R.layout.dr_tb_prev_treat_table, null));
   ...
   /* public void setValue(Object value) {
    ...
    public static class Builder extends BaseWidget.Builder{
        ...
        public int getRowSize() {
         ...
         public DRPreviousTBTreatmentTableWidget.Builder setBundle(Bundle bundle) {
             mBundle = bundle;
             return this;
         }
        ...
        public BaseWidget build() {
            ...
            DRPreviousTBTreatmentTableWidget widget = new DRPreviousTBTreatmentTableWidget(mContext);
