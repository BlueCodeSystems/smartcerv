...
public class DRTBOutcomeTableWidget extends BaseWidget {
    ...
    public DRTBOutcomeTableWidget(Context context) {
        super(context);
    }
    ...
    public void onCreateView() {
        ...
        this.addView(inflater.inflate(R.layout.dr_tb_output_table, null));
   ...
   /* public void setValue(Object value) {
    ...
    public static class Builder extends BaseWidget.Builder{
        ...
        public int getRowSize() {
         ...
         public DRTBOutcomeTableWidget.Builder setBundle(Bundle bundle) {
             mBundle = bundle;
             return this;
         }
        ...
        public BaseWidget build() {
            ...
            DRTBOutcomeTableWidget widget = new DRTBOutcomeTableWidget(mContext);
